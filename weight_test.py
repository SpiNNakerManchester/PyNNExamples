...
class lib_test_inhib2(object):
    ...
    def simulate_network(self, excitWeight):
        ...
        #                          # Was 0.018, reduced to dampen inhib noise
        #                          # to excit
        ...
        patternTiming = myStimulus.buildStream(
            ...
            interPatternGap=interPatternGap, offset=0.0,
            order=patternPresentationOrder)
        ...
        teachingInput.buildStream(
            numSources=nExcitNeurons, patterns=outPatterns,
            interPatternGap=interPatternGap, offset=-1.0, rng=rng, noise=None,
            runTime=runTime, order=teachingOrder)
        ...
        cyclic_stdp_timing_params_fwd = p.extra_models.TimingDependenceCyclic(
            ...
            # Excitatory 1
            accum_dep_thresh_excit=accDepThresholdExcit,
            accum_pot_thresh_excit=accPotThresholdExcit,
            pre_window_tc_excit=meanPreWindowExcit,
            post_window_tc_excit=meanPostWindowExcit,
            # Excitatory 2
            accum_dep_thresh_excit2=accDepThresholdExcit2,
            accum_pot_thresh_excit2=accPotThresholdExcit2,
            pre_window_tc_excit2=meanPreWindowExcit2,
            post_window_tc_excit2=meanPostWindowExcit2,
            # Inhibitory 1
            accum_dep_thresh_inhib=accDepThresholdInhib,
            accum_pot_thresh_inhib=accPotThresholdInhib,
            pre_window_tc_inhib=meanPreWindowInhib,
            post_window_tc_inhib=meanPostWindowInhib,
            # Inhibitory 2
            accum_dep_thresh_inhib2=accDepThresholdInhib2,
            accum_pot_thresh_inhib2=accPotThresholdInhib2,
            pre_window_tc_inhib2=meanPreWindowInhib2_fwd,
            post_window_tc_inhib2=meanPostWindowInhib2)

        cyclic_stdp_timing_params_rec = p.extra_models.TimingDependenceCyclic(
            accum_decay=accDecayPerSecond,
            # Excitatory 1
            accum_dep_thresh_excit=accDepThresholdExcit,
            accum_pot_thresh_excit=accPotThresholdExcit,
            ...
            accum_dep_thresh_inhib2=accDepThresholdInhib2,
            accum_pot_thresh_inhib2=accPotThresholdInhib2,
            pre_window_tc_inhib2=meanPreWindowInhib2_rec,
            post_window_tc_inhib2=meanPostWindowInhib2)
        ...
        # ### Populations:
        # Stimulus population:
        populations.append(p.Population(  # 0
            nStimulusNeurons,
        ...
        for j in range(nStimulusNeurons):
            for i in range(nExcitNeurons):
                conn_list.append((j, i, w, j * i * 0.2 % 2.4))
                w += 0.01
