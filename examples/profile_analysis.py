...
def plot_profile(n_neurons,test_duration,legend_dict):
    ...
    total_dma_time=[default['total_dma_time']]#,edge['total_dma_time']]
    total_spike_time=[default['total_spike_time']]#,edge['total_spike_time']]
    ...
    legend_dict['DMA'].append(n_neurons)
    ...
    legend_dict['SPIKES'].append(n_neurons)
