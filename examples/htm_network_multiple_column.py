...
cd_pop_size = 10 * active_pop_size
...
num_cd_connections =num_columns_active_per_pattern*1.5
...
tau_minus=30.
a_plus =0.5#1#0.001#
a_minus =1.#0.5#1#0.001#
w_min = 0
w_max = wpred

stdp_initial_weight = RandomDistribution('uniform',(0.,w_max/10.))
stdp_delays = RandomDistribution('uniform',(10.,14.))#1#
...
# cd_active_projection =  sim.Projection(cd_pop,active_pop,sim.FixedProbabilityConnector(p_connect=0.01),synapse_type=stdp_model)
