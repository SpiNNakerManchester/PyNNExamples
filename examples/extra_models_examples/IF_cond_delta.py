...
"""
A single LIF neuron with two exponential, conductance-based synapses,
and two delta, conductance-based synapses, fed by two spike sources.
"""
...
delta_cell = sim.Population(1, sim.extra_models.IF_cond_delta(**{
    'i_offset': 0.1,
    'tau_refrac': 3.0,
    'v_thresh': -51.0,
    'v_reset': -70.0}))
...
sim.Projection(spike_sourceE, exp_cell,
               ...
               synapse_type=sim.StaticSynapse(weight=0.015, delay=2.0),
               receptor_type='excitatory')
sim.Projection(spike_sourceI, exp_cell,
               sim.OneToOneConnector(),
               synapse_type=sim.StaticSynapse(weight=-0.015, delay=4.0),
