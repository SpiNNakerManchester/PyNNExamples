...
def test(g_D=2, g_L=0.1, exc_times=[1, 2, 5, 6], inh_times=[3, 4, 5, 6], exc_r_diff=[0.6, 0.2, 1.7, 1.4],
    ...
    soma_input1 = p.Population(1, p.RateSourceArray(rate_times=som_exc_times, rate_values=som_exc_r_diff, looping=4),
                               label='soma_exc_input')
    soma_input2 = p.Population(1, p.RateSourceArray(rate_times=som_inh_times, rate_values=som_inh_r_diff, looping=4),
