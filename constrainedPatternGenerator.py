...
class pattern(object):
    ...
    def __init__(self, totalNeurons, firing, cycleTime, numIntervals, numBins,
                 rng, spikeTrain=False, jitterSD=0.0, spuriousSpikeProb=0.0):
        """
        """
    ...
    def aboutPattern(self):
        ...
        print("Neurons: %d, firing: %d (%.1f%%),  cycle time: %d ms" % (
            self.totalNeurons, self.firing, percentFiring, self.cycleTime))
    ...
    def testGenerator(self):
        ...
        patt = pattern(2000, 100, 36, 4, 18, rng, spikeTrain=False,
                       jitterSD=0.0, spuriousSpikeProb=0.0)
        patt.printPattern()
...
class spikeStream(object):
    ...
    def buildStream(self, numSources=None, patterns=None, interPatternGap=10,
                    rng=None, offset=0.0, order=None, noise=None, runTime=0,
                    printTimes=False):
        """
        """
